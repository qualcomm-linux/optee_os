...
static inline vaddr_t get_drv_base(enum rscsw_drv_mapping drv_id)
{
...
enum hal_status hal_rpmh_register_drv(enum rscsw_drv_mapping drv_id)
{
...
enum hal_status hal_rpmh_read_config(enum rscsw_drv_mapping drv_id,
...
enum hal_status hal_rpmh_convert_to_amc(enum rscsw_drv_mapping drv_id,
					uint32_t tcs_id)
{
...
enum hal_status hal_rpmh_convert_to_tcs(enum rscsw_drv_mapping drv_id,
					uint32_t tcs_id)
{
	vaddr_t base, tcs_base;
	uint32_t control;
...
enum hal_status hal_rpmh_enable_amc_status(enum rscsw_drv_mapping drv_id,
					   uint32_t tcs_id)
{
	vaddr_t base;
	uint32_t enable;
...
enum hal_status hal_rpmh_clear_amc_status(enum rscsw_drv_mapping drv_id,
					  uint32_t tcs_id)
{
	vaddr_t base;
...
enum hal_status hal_rpmh_is_tcs_idle(enum rscsw_drv_mapping drv_id,
...
enum hal_status hal_rpmh_get_amc_status(enum rscsw_drv_mapping drv_id,
					uint32_t tcs_id,
					bool *finished)
{
	vaddr_t base;
...
enum hal_status hal_rpmh_send_tcs(enum rscsw_drv_mapping drv_id,
				  uint32_t tcs_id,
...
enum hal_status hal_rpmh_write_cmd(enum rscsw_drv_mapping drv_id,
...
enum hal_status hal_rpmh_update_epcb_timeout(enum rscsw_drv_mapping drv_id,
					     uint32_t threshold)
{
	vaddr_t base;
	uint32_t val;
...
enum hal_status hal_rpmh_toggle_epcb_timeout(enum rscsw_drv_mapping drv_id,
					     bool enable)
{
	vaddr_t base;
	uint32_t val;
