...
/*
 * Read the per-segment hash digest size for a root_cert_sel index.
 *
...
/*
 * Query whether OEM image encryption is provisioned.
 *
 ...
 */
#define PTA_QCOM_FUSE_GET_PIL_ROLLBACK_VERSION	9
 ...
 */
#define PTA_QCOM_FUSE_BLOW_PIL_ROLLBACK_VERSION	10
